  ...
  return (
    ...
    >
      ...
      <g transform={`rotate(${bearing} 25 25)`}>
        <path d="M25 5L28 22L25 20L22 22Z"
          fill="var(--t-accent, #C9A84C)" opacity=".9"
        />
        <path d="M25 45L28 28L25 30L22 28Z"
          fill="rgba(var(--t-accent-rgb, 201,168,76), .25)"
        />
      </g>

      {/* Cardinal direction letters (N/S/E/W) */}
      {[['N',25,4],['S',25,49],['E',47,26.5],['W',3,26.5]].map(([l,x,y]) => (
        <text
          key={l} x={x} y={y}
