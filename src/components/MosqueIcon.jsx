...
export default function MosqueIcon({ activePrayer = 'dhuhr', lunarPhase = 0.5 }) {
  ...
  return (
    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="mosque-icon-svg">
      <defs>
      ...
      <g transform="translate(50,50)" stroke={`url(#${goldId})`} fill="none">
        {/* Outer 8-point star */}
        <polygon points="0,-30 10,-10 30,0 10,10 0,30 -10,10 -30,0 -10,-10" strokeWidth="1.2" />
        {/* Inner vesica/tear-drop loop */}
        <path
          d="M0 -20 C10 -10 10 10 0 20 C-10 10 -10 -10 0 -20 Z"
          strokeWidth="0.8"
          opacity="0.8"
        />
      ...
      <path
        d="M58 35 A15 15 0 1 0 58 65 A12 12 0 1 1 58 35 Z"
        fill={`url(#${goldId})`}
        opacity={moonOp}
        filter={`url(#${glowId})`}
      />
      ...
      <polygon
        points="65,45 67,50 72,50 68,53 70,58 65,55 60,58 62,53 58,50 63,50"
        fill={`url(#${goldId})`}
        opacity={starOp}
      >
        <animate
