...
function FajrIcon() {
  return (
    <svg {...COMMON} aria-hidden="true">
      ...
      <path d="M14 17a6 6 0 1 1-4-10 5 5 0 0 0 4 10z" fill="currentColor" />
      ...
      <path
        d="M19 2l1 3.5L23.5 6.5l-3.5 1L19 11l-1-3.5L14.5 6.5l3.5-1z"
        fill="currentColor"
        stroke="none"
      />
    </svg>
...
function SunriseIcon() {
  return (
    <svg {...COMMON} aria-hidden="true">
      ...
      <path d="M6 17a6 6 0 0 1 12 0z" fill="currentColor" stroke="none" />
...
function AsrIcon() {
  return (
    <svg {...COMMON} aria-hidden="true">
      ...
      <path
        d="M5 17a3 3 0 0 1 1.5-5.6 4 4 0 0 1 7.5 1.6A2.5 2.5 0 0 1 14 17z"
        fill="var(--t-bg, #000)"
        stroke="currentColor"
      />
    </svg>
...
function MaghribIcon() {
  return (
    <svg {...COMMON} aria-hidden="true">
      ...
      <path d="M6 12a6 6 0 0 1 12 0z" fill="currentColor" stroke="none" />
...
function IshaIcon() {
  return (
    <svg {...COMMON} aria-hidden="true">
       ...
       * Islamic motif (☪). */}
      <path
        d="M14 7l.7 2.3L17 10l-2.3.7L14 13l-.7-2.3L11 10l2.3-.7z"
        fill="currentColor"
        stroke="none"
      />
    </svg>
