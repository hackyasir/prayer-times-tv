  ...
  return (
    <div className="sun-arc">
      ...
      >
        ...
        {inDaylight && (
          <path d={arcPath} className="sun-arc-path-active"/>
        )}
        ...
        {/* Current-sun dot — bright with glow halo */}
        {inDaylight && (
          <>
            <circle cx={sunPos.x} cy={sunPos.y} r="6"   className="sun-arc-sun-halo"/>
            <circle cx={sunPos.x} cy={sunPos.y} r="3.5" className="sun-arc-sun"/>
          </>
        )}
