// ── HeaderQibla — Qibla compass in the header centre (embedded layout) ──────
//
...
// label. Used in layoutVariant='embedded' to replace the decorative Arabic
// title "مواقيت الصلاة" at the centre of the header — that decoration is purely
// ornamental, while Qibla bearing is useful info, so the swap is a net win.
//
