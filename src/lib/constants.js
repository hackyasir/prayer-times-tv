...
export const HADITHS = [
  ...
  { ar: 'مَنْ حَافَظَ عَلَيْهَا كَانَتْ لَهُ نُوراً',       en: 'Who guards it — it will be light for them' },
  { ar: 'الصَّلَوَاتُ الْخَمْسُ كَفَّارَةٌ لِمَا بَيْنَهُنَّ', en: 'The five prayers expiate what is between them' },
];
